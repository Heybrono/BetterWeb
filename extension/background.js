...
`
  // dev-mode-ultimate  'dev-mode-ultimate': `
...
const FALLBACK_EXTENSIONS = [
  ...
  },
  {
    ...
    publisher: 'Leon.cgn.lx',
    version: '2.0.0',
    description: 'V3 Update: Added RGB Rainbow Theme! Animated gradients and better chat bubbles.',
  ...
  {
    id: 'mod-yt-ad-skipper',
    name: 'YouTube Ad Skipper',
    publisher: 'Leon.cgn.lx',
    version: '1.0.0',
    description: 'Automatically skips video ads and closes banners instantly.',
    privacy: 'Runs locally on youtube.com.',
    permissions: ['activeTab'],
    icon: '⏩',
    type: 'mod',
    entry: 'https://raw.githubusercontent.com/Heybrono/BetterWeb/main/store/mods/mod-yt-ad-skipper.js'
  },
  {
    id: 'mod-page-summarizer',
    name: 'Page Summarizer',
    publisher: 'Leon.cgn.lx',
    version: '1.0.0',
    description: 'Summarize the current page into key sentences + keywords (offline).',
    privacy: 'Runs locally. No network calls.',
    permissions: ['activeTab'],
    icon: '🧠',
    type: 'mod',
    entry: 'https://raw.githubusercontent.com/Heybrono/BetterWeb/main/store/mods/mod-page-summarizer.js'
  },

  {
    ...
    publisher: 'Leon.cgn.lx',
    version: '1.0.0',
    description: 'Animated RGB rainbow gradient for the ultimate gamer look.',
    privacy: 'CSS only.',
    permissions: ['storage'],
    icon: '🌈',
    type: 'theme',
    entry: 'https://raw.githubusercontent.com/Heybrono/BetterWeb/main/store/mods/theme-rainbow.js'
  },
  {
    id: 'theme-midnight',
